...
public class MainActivity2Test2 {
    ...
    public void mainActivity2Test2() {
        ...
        ViewInteraction materialButton3 = onView(
                allOf(withId(R.id.btSumar), withText("Sumar"),
                        childAtPosition(
                                allOf(withId(R.id.linearLayout),
                                        childAtPosition(
                                                withClassName(is("androidx.constraintlayout.widget.ConstraintLayout")),
        ...
        ViewInteraction editText2 = onView(
                allOf(withId(R.id.txtNro2), withText("8"),
                        withParent(allOf(withId(R.id.linearLayout),
                                withParent(IsInstanceOf.<View>instanceOf(android.view.ViewGroup.class)))),
                        isDisplayed()));
        editText2.check(matches(withText("8")));

        ViewInteraction textView = onView(
                allOf(withId(R.id.tvResultado), withText("11"),
                        withParent(allOf(withId(R.id.linearLayout),
                                withParent(IsInstanceOf.<View>instanceOf(android.view.ViewGroup.class)))),
                        isDisplayed()));
